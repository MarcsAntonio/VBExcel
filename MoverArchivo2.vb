Sub MoverArchivo2()
	...
	Dim Origen, Usuario, Destino, UltmaLine, FechaGestion, NameMesGestion, NombreMP3, CarDes, CarDesRut, CarOriRut, ExisteCarpeta, ExisteArchivo, CopiArch As String
	...
	UltmaLine = ThisWorkbook.Sheets("BDD").UsedRange.Columns("BN").Rows.Count
		...
		For i = 3 To UltmaLine
			Verifica = ThisWorkbook.Sheets("BDD").Cells(i, 68)
